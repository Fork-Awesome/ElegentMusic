...
var PlayList = React.createClass({displayName: "PlayList",
    render: function () {
        ...
        var nowPlayListNodes = this.props.nowPlayList.map(function (song) {
            console.log(song)
            return (
                React.createElement(SongItem, {handleSelectMusic: this.props.handleSelectMusic, songName: song.name, singer: song.singer, songIndex: song.index, nowPlaySongIndex: nowPlaySongIndex})
            )
        })
        return (
