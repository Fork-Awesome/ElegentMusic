    ...
    render: function () {
        return (
            React.createElement("div", {className: "musicBox"}, 
                ...
                React.createElement(PlayBar, {nowMusic: this.state.nowMusic, nowPlayState: this.state.nowPlayState})
            )
        )
    }
});
    ...
    render: function () {
        return (
            React.createElement("nav", {id: "playBarNav", className: "bar bar-tab"}, 
                ...
                this.props.nowPlayState=='playing'?React.createElement("span", {className: "icon icon-pause"}):React.createElement("span", {className: "icon icon-play"}), 
