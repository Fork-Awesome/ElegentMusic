...
var SongList = React.createClass({displayName: "SongList",
    ...
    render: function() {
        var songNodes = this.props.data.map(function(song) {
            return (
                React.createElement(SongInfo, {from: song.from, songId: song.id, songName: song.name, songSinger: song.singer})
    ...
    render: function() {
        return (
            React.createElement("div", {onclick: "playMusic", id: this.props.songId, className: "SongInfo"}, 
                ...
                React.createElement("p", {style: "visibility: none;", className: "from"}, "this.props.from")
            )
        );
    }
});
