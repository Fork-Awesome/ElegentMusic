    ...
    render: function () {
        return (
            React.createElement("div", {className: "musicBox"}, 
                ...
                React.createElement(PlayBar, {handleChangePlayState: handleChangePlayState, nowMusic: this.state.nowMusic, nowPlayState: this.state.nowPlayState})
            )
        )
    }
});
    ...
    render: function () {
        return (
            React.createElement("nav", {id: "playBarNav", className: "bar bar-tab"}, 
                ...
                this.props.nowPlayState=='playing'?React.createElement("span", {onClick: this.changePlayState.bind(this), className: "icon icon-pause"})
                :React.createElement("span", {onClick: this.changePlayState.bind(this), className: "icon icon-play"}), 
