...
var MusicBox = React.createClass({displayName: "MusicBox",
    handleChangePlayState: function () {
        ...
        chrome.extension.sendRequest({ greeting: "changeState", listName: listName }, function (response) { });
    },
    ...
    render: function () {
        return (
            React.createElement("div", {className: "musicBox"}, 
                ...
                React.createElement(PlayBar, {handleChangePlayState: this.handleChangePlayState, nowMusic: this.state.nowMusic, nowPlayState: this.state.nowPlayState})
            )
        )
    }
});
