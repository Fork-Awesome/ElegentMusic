    ...
    render: function () {
        return (
            React.createElement("div", {className: "content"}, 
                React.createElement("ul", {className: "table-view"}, 
                    React.createElement("li", {className: "table-view-cell media"}, "1"), 
                     React.createElement("li", {className: "table-view-cell media"}, React.createElement(SongItem, null)), 
                     React.createElement("li", {className: "table-view-cell media"}, "2")
                )
            )
        )
    }
