    ...
    render: function () {
        return (
            React.createElement("div", {className: "musicBox"}, 
                ...
                React.createElement(PlayLists, {playList: this.props.playList, nowMusicIndex: this.props.nowMusicIndex}), 
...
var SongsList = React.createClass({displayName: "SongsList",
    render: function () {
        var nowSongListNodes = this.props.nowSongList.map(function (song) {
            console.log(song)
            return (
                React.createElement(SongItem, {songName: song.name, singer: song.singer, songIndex: song.songIndex})
            )
        })
        return (
...
var SongItem = React.createClass({displayName: "SongItem",
    render: function () {
        ...
        if(this.props.songIndex==this.props.nowMusicIndex){
            playGreenState=" <div className='isPlaying'></div>"
        }else{
            playGreenState=" <div className='isnotPlaying'></div>"
        }
        return (
