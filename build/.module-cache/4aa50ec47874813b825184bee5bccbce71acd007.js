    ...
    render: function () {
        return (
            React.createElement("div", {className: "musicBox"}, 
                ...
                React.createElement(AllPlayList, {onSelectList: this.handleSelectList, playList: this.state.playList}), 
                React.createElement(SongsList, {nowPlayList: this.state.nowPlayList, nowMusicIndex: this.state.nowMusicIndex}), 
...
var AllPlayList = React.createClass({displayName: "AllPlayList",
    render: function () {
        var onSelectList = this.props.onSelectList;
        var AllPlayListNodes = this.props.playList.map(function (list) {
            return (
